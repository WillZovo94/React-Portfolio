        ...
        <div id="container"></div>
            ...
            <div id="about-section">
                ...
                <p id="about-info">Hello! My name is William and welcome to my portfolio. 
                    ...
                    the more I love creating projects and testing myself to improve day by day. Learning both front and back
                    end technologies, I inspire to develop my skills for a full stack developer!
                     </p>
            </div>
        </div>
    )
